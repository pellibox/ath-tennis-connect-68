...
const ButtonLink = ({
  ...
  const baseClasses = "inline-flex items-center justify-center text-center transition-all duration-300 rounded-full font-swiss"; // Changed rounded-md to rounded-full
