...
const FacilitiesSection = ({
  ...
  return (
    <section id="facilities" className={cn("pt-0 pb-12 px-4 md:px-8 bg-white", className)}>
      <div className="max-w-7xl mx-auto">
        <RevealAnimation>
          <h2 className="text-3xl md:text-4xl font-swiss text-center mb-4">{title}</h2>
          {subtitle && (
            <p className="text-lg text-center max-w-3xl mx-auto mb-8 text-gray-600 font-swiss">
              {subtitle}
            </p>
          )}
        </RevealAnimation>
        ...
        <div className="mt-6">
          {facilities.map((facility, index) => (
            <div
              ...
              id={facility.id}
              className={cn(
                "mb-14 last:mb-0 grid grid-cols-1 md:grid-cols-2 gap-8 items-center",
