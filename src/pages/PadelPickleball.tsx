...
import { programCategories } from '@/data/padelPickleball/categories';

const PadelPickleball = () => {
  useEffect(() => {
      ...
      <main className="flex-grow pt-20">
        ...
        <RevealAnimation>
          <div className="container mx-auto px-6 py-16">
            <h1 className="text-4xl md:text-5xl font-display mb-4">Padel & Pickleball</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Scopri i nostri programmi di allenamento esclusivi per Padel e Pickleball, progettati con la stessa metodologia innovativa ATH.
            </p>
          </div>
        </RevealAnimation>
        
        <ProgramsSection 
          title="Programmi di Padel & Pickleball"
        ...
        <AboutSection 
          title="Il Metodo ATH per Padel & Pickleball"
          description={
            <div className="space-y-4">
              <p>
                ATH ha esteso la sua metodologia innovativa anche al Padel e al Pickleball, due sport in rapida crescita che combinano elementi del tennis con dinamiche di gioco uniche.
              </p>
              <h3 className="text-xl font-semibold mt-6 mb-2">Sviluppo Tecnico</h3>
              <p>
                I nostri coach specializzati utilizzano analisi video avanzate e feedback in tempo reale per perfezionare la tua tecnica su tutti i colpi specifici di Padel e Pickleball.
              </p>
              <h3 className="text-xl font-semibold mt-6 mb-2">Strategia & Tattica</h3>
              <p>
                Sviluppiamo il tuo pensiero tattico per il gioco in coppia, la capacità di sfruttare le pareti nel Padel e le dinamiche di gioco rapido nel Pickleball.
              </p>
              <h3 className="text-xl font-semibold mt-6 mb-2">Preparazione Fisica</h3>
              <p>
                Programmi di fitness personalizzati specifici per Padel e Pickleball, focalizzati su agilità, riflessi, equilibrio e coordinazione.
              </p>
              <h3 className="text-xl font-semibold mt-6 mb-2">Allenamento Mentale</h3>
              <p>
                Tecniche per sviluppare la concentrazione e la resilienza mentale necessarie in sport rapidi e dinamici come Padel e Pickleball.
              </p>
              <p className="mt-4">
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <RevealAnimation delay={300}>
                <div className="bg-white p-8 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow h-full flex flex-col">
                  <div className="mb-6">
                    <h3 className="text-2xl font-medium text-center mb-2">Pickleball</h3>
                    <p className="text-center text-gray-600">Per tutti i livelli</p>
                  </div>
                  <div className="text-center mb-6">
            ...
            <div className="mt-12 text-center">
              <p className="text-gray-600 mb-4">Pacchetti personalizzati e lezioni private disponibili su richiesta</p>
...
export default PadelPickleball;
