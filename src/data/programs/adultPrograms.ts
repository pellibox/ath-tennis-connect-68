...
export const adultPrograms: Program[] = [
  {
    id: '6',
    titleKey: 'programs.adult.amateur.title',
    title: 'Amatori',
    descriptionKey: 'programs.adult.amateur.description',
    ...
    featureKeys: [
      'programs.adult.amateur.feature1',
      'programs.adult.amateur.feature2',
      'programs.adult.amateur.feature3',
      'programs.adult.amateur.feature4',
      'programs.adult.amateur.feature5',
      'programs.adult.amateur.feature6'
    ],
    features: [
